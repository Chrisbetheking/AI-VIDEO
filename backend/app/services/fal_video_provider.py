# V10_27O_STRIP_RUNTIME_KWARGS_INSIDE_WRAPPER_FIXED\n# V10_27O_STRIP_RUNTIME_KWARGS_INSIDE_WRAPPER
...
def _v10_27k_wrap_callable(_v10_27k_name, _v10_27k_fn):
    try:
        ...
        _v10_27k_strip_keys = (
            "runtime_prompt_cleaner",
            "runtime_semantic_lock",
            "prompt_purge_lock",
            "demand_acceptance_lock",
            "semantic_direct_render",
            "shot_duration_policy",
            "source_priority",
            "v10_27m_no_final_prompt_append",
            "runtime_semantic_guard",
            "manual_shot_runtime_lock",
        )

        def _v10_27k_strip_kwargs(_kwargs):
            for _v10_27k_key in _v10_27k_strip_keys:
                _kwargs.pop(_v10_27k_key, None)
            return _kwargs
        ...
        if _v10_27k_inspect.iscoroutinefunction(_v10_27k_fn):
            ...
            async def _v10_27k_async_wrapped(*args, **kwargs):
                _v10_27k_strip_kwargs(kwargs)
                res = await _v10_27k_fn(*args, **kwargs)
                return _v10_27k_clean_runtime_prompt_fields(res)
...
# V10_27N_FAL_GENERATE_KWARGS_STRIP
try:
    _v10_27n_original_generate_fal_video = generate_fal_video

    def generate_fal_video(*args, **kwargs):
        # These are internal orchestration flags used by the TTS-first semantic pipeline.
        # They must never be forwarded to the low-level FAL provider.
        for _k in (
            "runtime_prompt_cleaner",
            "runtime_semantic_lock",
            "prompt_purge_lock",
        ...
        for _v10_27o_k in (
            ...
            kwargs.pop(_v10_27o_k, None)
        return _v10_27n_original_generate_fal_video(*args, **kwargs)

    print("V10_27N_FAL_GENERATE_KWARGS_STRIP_INSTALLED")
except Exception as _v10_27n_exc:
    print("V10_27N_FAL_GENERATE_KWARGS_STRIP_INSTALL_FAILED=" + repr(_v10_27n_exc))
