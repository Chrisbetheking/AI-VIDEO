...
def install_fal_prompt_guard_v10_16(app: FastAPI | None = None) -> None:
    ...
    try:
        ...
        _INSTALLED = True
        print("V10_18_DEEPSEEK_VISUAL_FAL_PROMPT_GUARD_INSTALLED for v10_16", flush=True)
    except Exception as exc:
        print("V10_18_DEEPSEEK_VISUAL_FAL_PROMPT_GUARD_INSTALL_FAILED for v10_16", exc, flush=True)
    if app is not None:
        try:
...
def health() -> dict[str, Any]:
    return {
        "ok": True,
        "provider": "fal_prompt_guard_v10_16_v10_18_deepseek_visual",
